...
const Details = () => {
  ...
  const aboutMyself = `
    Full Stack Developer with 2+ years of experience building scalable web and mobile applications using React,
React Native, Node.js, and TypeScript. Strong experience designing backend APIs, real-time systems, and
data-driven dashboards, along with building polished frontend interfaces and AI-integrated products. Currently
working remotely at Freedom Property Investors (Sydney, Australia), delivering production-grade solutions with
clean architecture, performance, and scalability in mind.
    `
  ...
  useEffect(() => {
    const handleResize = () => setIsMobile(window.innerWidth <= 572);
    window.addEventListener("resize", handleResize);
    return () => window.removeEventListener("resize", handleResize);
  }, []);
  ...
  useEffect(() => {
    expControls.start(expInView ? "visible" : "hidden");
  ...
  const experiences = [
    {
      ...
      points: [
        "Built an enterprise Google Calendar–like system with AI summaries, transcripts, post-meeting analysis, and performance scoring.",
        "Designed analytics dashboard providing actionable meeting insights and summary metrics.",
        "Built fully responsive marketing website (tech-solutions.ai) using React, Tailwind, Framer Motion.",
        "Built Property Pathfinder – property value calculator using Excel FV formulas in React.",
        "Developing scalable CRM aggregating meetings, analytics, and deal information."
      ]
    },
    {
      company: "Jan Elaaj",
      ...
      points: [
        "Built remote healthcare group video call app similar to Google Meet.",
        "Integrated real-time ASR transcription and emotion detection models.",
        "Built backend for community app with posts, chat, and doctor consultations.",
        "Created GitHub code manager to track pushes, merges, and deletions."
      ]
    },
    {
      company: "StoreShoppy Pvt. Ltd.",
      duration: "Feb 2024 – May 2024",
      role: "React JS Developer",
      location: "Sector 63, Noida",
      points: [
        "Built online payment gateway (Reduxpay) using Razorpay APIs.",
        "Developed trading web app (Liquidity Funder) integrating multiple brokers."
      ]
    }
  ]
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black justify-center" >
      ...
      <div className="mt-10 sm1:ml-[16%] sm:ml-[20%] ">
        ...
        <motion.p style={{ translateX: formydetail, opacity: foropacity }} className=' text-white max-w-[1500px]'>
          {aboutMyself}
        </motion.p>

      </div>

      <div className="ml-auto sm1:mr-[16%] sm:mr-[20%] sm1:w-[30%] sm:w-[60%] mt-6">
        ...
        <motion.h1 style={{ translateX: formyskill, opacity: foropacity }} className="text-white flex flex-col font-semibold text-lg">Languages: <span className="text-white font-normal text-base">Javascript, Typescript, GO, C/C++, SQL, HTML/CSS</span></motion.h1>
        <motion.h1 style={{ translateX: formyskill, opacity: foropacity }} className="text-white flex flex-col font-semibold text-lg">Frameworks & Libraries: <span className="text-white font-normal text-base">React.js, React Native, Express.js, Tailwind CSS, Framer Motion</span></motion.h1>
        <motion.h1 style={{ translateX: formyskill, opacity: foropacity }} className="text-white flex flex-col font-semibold text-lg">Backend & Real-Time: <span className="text-white font-normal text-base">Node.js, Socket.IO, WebRTC, PeerJS, Prisma, Mongoose</span></motion.h1>
        <motion.h1 style={{ translateX: formyskill, opacity: foropacity }} className="text-white flex flex-col font-semibold text-lg">Databases: <span className="text-white font-normal text-base">MySQL, MongoDB, Firebase</span></motion.h1>
        <motion.h1 style={{ translateX: formyskill, opacity: foropacity }} className="text-white flex flex-col font-semibold text-lg">Cloud & Developer Tools: <span className="text-white font-normal text-base">AWS, GCP, Docker, Git</span></motion.h1>
      ...
      <motion.div
        ...
        initial="hidden"
        animate={expControls}
        className="mt-16 sm1:ml-[16%] sm:ml-[20%]"
      >
