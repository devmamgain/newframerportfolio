...
const Details =()=>{
    ...
    // const chunks = splitIntoChunks(myselfbreak, 6);
        ...
        <div className="flex flex-col min-h-screen bg-black" >
          <div className="mt-10 ml-[20%] w-[30%]">
             <motion.span ref={containRef} className='text-3xl text-white ' variants={{visible:{y:0, transition:{duration:0.3, staggerChildren:0.1}}, hidden:{y:20}}} animate={maincontrol} initial="hidden">
...
<div className="ml-auto mr-[20%] w-[30%]">

<motion.div ref={containRef} className='text-center text-3xl text-white' variants={{visible:{y:0, transition:{duration:0.3, staggerChildren:0.1}}, hidden:{y:20}}} animate={maincontrol} initial="hidden">
  {  aboutskillbreak.map((datahead,index )=><motion.span className=' inline-block' key={index} variants={{visible:{y:0,opacity:1, transition:{duration:0.3}}, hidden:{y:20,opacity:0}}}>{datahead}</motion.span>
     ...
     <div className="flex flex-wrap mt-20 p-10 gap-[10%] justify-center">
     <motion.svg
